...
module.exports.run = async (bot, message, args) => {
    ...
    if (message.channel.id === arkSupport || message.channel.id === atlasSupport) {
        if (message.channel.id === arkSupport) {
        ...
        if (message.channel.id === atlasSupport) {
            const embed = new Discord.RichEmbed()
        ...
        // if (message.channel.id === conanSupport) {
        //   const embed = new Discord.RichEmbed()
